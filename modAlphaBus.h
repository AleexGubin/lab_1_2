#include  "modAlphaBus.h"

using namespace std;

std::wstring modAlphaBus::encrypt(const std::wstring& open_text) // шифрование
{
...
std::wstring modAlphaBus::decrypt(const std::wstring& cipher_text) // расшифрование
{
